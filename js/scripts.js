...
function PreparaAnys() {
    ...
    if (nom_col1 == "Escollir 1er paràmetre") {
    ...
    else if (nom_col1 == "ABSTENCIÓ (2011)") {
        Districte = false;
        netejaTaulacol1();
        $(".etiqueta").fadeTo("slow", 0);
        $(".any01").fadeTo("slow", 0);
    ...
    else if (nom_col1 == "ABSTENCIÓ (2015)") {
        Districte = false;
        netejaTaulacol1();
        $(".etiqueta").fadeTo("slow", 0);
        $(".any01").fadeTo("slow", 0);
        ...
        $(".any06").fadeTo("slow", 0);
        colorData_dis.length = 0;
        file1 = "dades/e_percent_abstencio.csv";
        handleFileSelect_distribucio(file1);
        handleFileSelect_cuartils_distrib(file1);
    }
...
function ResetTaulaCol2() {
    ...
    var ddData_2 = [{
        ...
        text: "Resultats eleccions locals 24 de maig 2015",
        value: 20,
        selected: false,
    }, {
        text: "B-Comú",
    ...
    $('#select_cuartils').ddslick({
        ...
        onSelected: function(data) {
            ...
            if (triat == 1) {
                ...
                nom_col1 = "ABSTENCIÓ (2015)";
                $("#titol1").text("Abstenció (2015)");
                $("#textcampanya").html("Cal més implicació ciutadana i més participació ciutadana per resoldre entre totes i tos els problemes concrets de les persones que viuen a Barcelona. Cal una revolució democràtica ja!");
                $("#textintro").css("opacity", "1");
                $("#textintro").html("Font 1a col.: <a href='http://www.bcn.cat/estadistica/catala/dades/telec/loc/loc15/A17.htm' target='_new' class='font'>Ajuntament de Barcelona</a>. Eleccions Locals a Barcelona. 24 maig 2015. Percentatge sobre electors");
                PreparaAnys();
            }
        }
    });
    ...
    $('#select_percent').ddslick({
        ...
        onSelected: function(data) {
            ...
            if (triat == 1) {
                ...
                file = "dades/e_percent_bcomu.csv";
                nom_col2 = "B-COMÚ";
                esperansa = false;
                $("#titol2").text(" / Votants B-Comú");
                pieData_modal.length = 0;
                handleFileSelect_pastissos(file);
                $("#textintro_col2").css("opacity", "1");
                $("#textintro_col2").html("Font 2a col.: <a href='http://www.bcn.cat/estadistica/catala/dades/telec/loc/loc15/A17.htm' target='_new' class='font'>Ajuntament de Barcelona</a>. Eleccions Locals a Barcelona. 24 maig 2015. Percentatge sobre votants");
            } else if (triat == 11) {
                file = "dades/e_percent_ciu.csv";
                nom_col2 = "CiU";
                esperansa = false;
                $("#titol2").text(" / Votants CiU");
                pieData_modal.length = 0;
                handleFileSelect_pastissos(file);
                $("#textintro_col2").css("opacity", "1");
                $("#textintro_col2").html("Font 2a col.: <a href='http://www.bcn.cat/estadistica/catala/dades/telec/loc/loc15/A17.htm' target='_new' class='font'>Ajuntament de Barcelona</a>. Eleccions Locals a Barcelona. 24 maig 2015. Percentatge sobre votants");
            } else if (triat == 12) {
                file = "dades/e_percent_cs.csv";
                nom_col2 = "C's";
                esperansa = false;
                $("#titol2").text(" / Votants C's");
                pieData_modal.length = 0;
                handleFileSelect_pastissos(file);
                $("#textintro_col2").css("opacity", "1");
                $("#textintro_col2").html("Font 2a col.: <a href='http://www.bcn.cat/estadistica/catala/dades/telec/loc/loc15/A17.htm' target='_new' class='font'>Ajuntament de Barcelona</a>. Eleccions Locals a Barcelona. 24 maig 2015. Percentatge sobre votants");
            } else if (triat == 13) {
                file = "dades/e_percent_erc.csv";
                nom_col2 = "ERC";
                esperansa = false;
                $("#titol2").text(" / Votants ERC");
                pieData_modal.length = 0;
                handleFileSelect_pastissos(file);
                $("#textintro_col2").css("opacity", "1");
                $("#textintro_col2").html("Font 2a col.: <a href='http://www.bcn.cat/estadistica/catala/dades/telec/loc/loc15/A17.htm' target='_new' class='font'>Ajuntament de Barcelona</a>. Eleccions Locals a Barcelona. 24 maig 2015. Percentatge sobre votants");
            } else if (triat == 14) {
                file = "dades/e_percent_psc.csv";
                nom_col2 = "PSC-CP";
                esperansa = false;
                $("#titol2").text(" / Votants PSC-CP");
                pieData_modal.length = 0;
                handleFileSelect_pastissos(file);
                $("#textintro_col2").css("opacity", "1");
                $("#textintro_col2").html("Font 2a col.: <a href='http://www.bcn.cat/estadistica/catala/dades/telec/loc/loc15/A17.htm' target='_new' class='font'>Ajuntament de Barcelona</a>. Eleccions Locals a Barcelona. 24 maig 2015. Percentatge sobre votants");
            } else if (triat == 15) {
                file = "dades/e_percent_pp.csv";
                nom_col2 = "PP";
                esperansa = false;
                $("#titol2").text(" / Votants PP");
                pieData_modal.length = 0;
                handleFileSelect_pastissos(file);
                $("#textintro_col2").css("opacity", "1");
                $("#textintro_col2").html("Font 2a col.: <a href='http://www.bcn.cat/estadistica/catala/dades/telec/loc/loc15/A17.htm' target='_new' class='font'>Ajuntament de Barcelona</a>. Eleccions Locals a Barcelona. 24 maig 2015. Percentatge sobre votants");
            } else if (triat == 16) {
                file = "dades/e_percent_cup.csv";
                nom_col2 = "CUP-PA";
                esperansa = false;
                $("#titol2").text(" / Votants CUP-PA");
                pieData_modal.length = 0;
                handleFileSelect_pastissos(file);
                $("#textintro_col2").css("opacity", "1");
                $("#textintro_col2").html("Font 2a col.: <a href='http://www.bcn.cat/estadistica/catala/dades/telec/loc/loc15/A17.htm' target='_new' class='font'>Ajuntament de Barcelona</a>. Eleccions Locals a Barcelona. 24 maig 2015. Percentatge sobre votants");
            } else if (triat == 17) {
                file = "dades/e_percent_altres.csv";
                nom_col2 = "Altres";
                esperansa = false;
                $("#titol2").text(" / Votants Altres");
                pieData_modal.length = 0;
                handleFileSelect_pastissos(file);
                $("#textintro_col2").css("opacity", "1");
                $("#textintro_col2").html("Font 2a col.: <a href='http://www.bcn.cat/estadistica/catala/dades/telec/loc/loc15/A17.htm' target='_new' class='font'>Ajuntament de Barcelona</a>. Eleccions Locals a Barcelona. 24 maig 2015. Percentatge sobre votants");
            } else if (triat == 18) {
                file = "dades/e_percent_blancs.csv";
                nom_col2 = "en Blanc";
                esperansa = false;
                $("#titol2").text(" / Votants en Blanc");
                pieData_modal.length = 0;
                handleFileSelect_pastissos(file);
                $("#textintro_col2").css("opacity", "1");
                $("#textintro_col2").html("Font 2a col.: <a href='http://www.bcn.cat/estadistica/catala/dades/telec/loc/loc15/A17.htm' target='_new' class='font'>Ajuntament de Barcelona</a>. Eleccions Locals a Barcelona. 24 maig 2015. Percentatge sobre votants");
            } else if (triat == 19) {
                file = "dades/e_percent_nuls.csv";
                nom_col2 = "Nuls";
                esperansa = false;
                $("#titol2").text(" / Vots nuls");
                pieData_modal.length = 0;
                handleFileSelect_pastissos(file);
                $("#textintro_col2").css("opacity", "1");
                $("#textintro_col2").html("Font 2a col.: <a href='http://www.bcn.cat/estadistica/catala/dades/telec/loc/loc15/A17.htm' target='_new' class='font'>Ajuntament de Barcelona</a>. Eleccions Locals a Barcelona. 24 maig 2015. Percentatge sobre votants");
            } else if (triat == 20) {
                file = "dades/e_percent_abstencio.csv";
                nom_col2 = "Abstenció (2015)";
                esperansa = false;
                $("#titol2").text(" / Abstenció (2015)");
                pieData_modal.length = 0;
                handleFileSelect_pastissos(file);
                $("#textintro_col2").css("opacity", "1");
                $("#textintro_col2").html("Font 2a col.: <a href='http://www.bcn.cat/estadistica/catala/dades/telec/loc/loc15/A17.htm' target='_new' class='font'>Ajuntament de Barcelona</a>. Eleccions Locals a Barcelona. 24 maig 2015. Percentatge sobre electors");
            }
        }
    });
});
